...
import { P005RegistroComponent } from './pages/P005-registro/P005-registro.component';
...
export const routes: Routes = [
  ...
  },
  {
    path: 'registro',
    loadComponent: () =>
      import('./pages/P005-registro/P005-registro.component').then(
        (m) => m.P005RegistroComponent
      ),
  },
  {
    path: '**',
